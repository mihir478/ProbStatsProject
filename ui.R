...
shinyUI(fluidPage(theme="theme.css",
                  ...
                  sidebarPanel(
                    wellPanel(
                      ...
                      #checkboxInput(inputId = "stock_xom", label = "Exxon Mobile (XOM)", value = TRUE),
                      checkboxInput(inputId = "stock_spy", label = "S&P 500 (SPY)", value = TRUE),
                      selectInput("tickers", "Tickers:", choices = c("Apple (AAPL)", "Exxon Mobile (XOM)", "J P Morgan (JPM)", "Boeing (BA)"))
                    )
                  ),
                  ...
                  mainPanel(
                    tabsetPanel(
                      ...
                      tabPanel("Stock Regression with SPY",
                               conditionalPanel(condition = "input.tickers == 'Apple (AAPL)' && input.stock_spy",
                                                br(),
                               ...
                               conditionalPanel(condition = "input.tickers == 'Exxon Mobile (XOM)' && input.stock_spy",
                                                br(),
                               ...
                               conditionalPanel(condition = "input.tickers == 'J P Morgan (JPM)' && input.stock_spy",
                                                br(),
                               ...
                               conditionalPanel(condition = "input.tickers == 'Boeing (BA)' && input.stock_spy",
                                                br(),
